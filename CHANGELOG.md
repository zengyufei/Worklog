...
- Remove outdated modeling images and PlantUML files
...
- Release v1.3.0 with database lazy loading, Linux rendering stability, and a revised update workflow
...
- Enable dynamic version fetching and update AppImage download URL in install script

### 🐛 Bug Fixes

- Remove unused utility files and associated references
...
- Update installation script to copy full icon directory structure instead of a single file and remove obsolete icon path

### 🚜 Refactor

- Update install script to extract AppImage contents for native execution and improved compatibility
